...
<img src="utils/bot_image.jpg" alt="PrimeSA_Bot" width="260">

</div>

PrimeSA_Bot is a WhatsApp MD bot built on top of the **Baileys** library.  
...
-> This creates your own copy of `PrimeSA_Bot` under your GitHub account.
...
```bash
git clone https://github.com/mruniquehacker/PrimeSA_Bot.git
cd PrimeSA_Bot
```
