...
const { handleStatus } = require('./commands/group/autostatus');
...
const handleAntilink = async (sock, msg, groupMetadata) => {
  try {
    ...
    // Narrower link detection: require protocol or common short links (wa.me, t.me, chat.whatsapp.com)
    const linkPattern = /(https?:\/\/[^\s]+)|(wa\.me\/[^\s]+)|(t\.me\/[^\s]+)|(chat\.whatsapp\.com\/[0-9A-Za-z]+)/i;
